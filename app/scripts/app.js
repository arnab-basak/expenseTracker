...
.run(function ($templateCache) {
    ...
    $templateCache.put('passwordMismatchError', '<div class="errorSuccessTemplate templateFontSize"> <i class="assertive ion-information-circled ionicIconSize"></i><span class="errorSuccessTextAlign">&nbsp;&nbsp;Passwords Do not Match!</span> </div>');
    $templateCache.put('createUserSuccess', '<div class="errorSuccessTemplate"> <i class="balanced ion-checkmark-circled ionicIconSize"></i><span class="errorSuccessTextAlign">&nbsp;&nbsp;User Created Successfully!</span> </div>');
    $templateCache.put('userExists','<div class="errorSuccessTemplate"> <i class="assertive ion-information-circled ionicIconSize"></i><span class="errorSuccessTextAlign">&nbsp;&nbsp;Username already exists!</span> </div>');
    $templateCache.put('invalidEmail','<div class="errorSuccessTemplate"> <i class="assertive ion-information-circled"></i><span class="errorSuccessTextAlign">&nbsp;&nbsp;Invalid Email Address</span> </div>');
    $templateCache.put('invalidPassword','<div class="errorSuccessTemplate"> <i class="assertive ion-information-circled"></i><span class="errorSuccessTextAlign">&nbsp;&nbsp;Password should be 8 characters minimum</span> </div>');
